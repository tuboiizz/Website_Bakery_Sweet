...
public function getCartProduct(){
	...
	if ($updated_row) {
		header("Location:cart.php");
			...
			$msg = "<span class='error'>Số lượng chưa cập nhật!</span>";
				return $msg;
	}
	}
...
$msg = "<span class='error'>Sản phẩm chưa bị xóa!</span>";
	...
	if ($updated_row) {
		$msg = "<span class='success'>Cập nhật thành công.</span>";
			...
			$msg = "<span class='error'>Chưa cập nhật!</span>";
				return $msg;
	}
	...
	public function delProductShifted($id){
	    ...
	    $deldata = $this->db->delete($query);
	    if ($deldata) {
		$msg = "<span class='success'>Đã xóa dữ liệu thành công.</span>";
				return $msg;
	}else{
$msg = "<span class='error'>Dữ liệu chưa bị xóa!</span>";
				return $msg;
