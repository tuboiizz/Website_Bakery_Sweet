...
.payment1 a{background: #ff0000 none repeat scroll 0 0;border-radius: 3px;color: #fff;font-size: 25px;padding: 5px 10px;}
 ...
 <div class="main">
    <div class="content">
    	...
    	<div class="payment1">
    		...
    		<a href="paymentoffline.php">Thanh toán Offline</a>
    		<a href="paymentonline.php">Thanh toán Online</a>
    	</div>
    	<div class="back">
